...
class SitemapController
{
    ...
    public function sitemap()
    {
        ...
        return $this->templating->renderResponse('AvalancheSitemapBundle:Sitemap:sitemap.xml.twig', array(
    ...
    {
        return $this->templating->renderResponse('AvalancheSitemapBundle:Sitemap:siteindex.xml.twig', array(
